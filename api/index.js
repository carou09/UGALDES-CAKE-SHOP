...
const CANONICAL_HOST = process.env.CANONICAL_HOST || 'admin-ugaldes-cake-shop.vercel.app';
...
const SOCIAL_IMAGE_URL = `https://${CANONICAL_HOST}/img/LOGO.png`;
let pool;
